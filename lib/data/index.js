...
import cpluspdfdata from './cpluspluspdf/index'
import pythonpdfdata from './pythonpdf/index'
import javapdfdata from './javapdf/index'

export default {
  gimp: gimpdata,
  inkscape: inkscapedata,
  audacity: audacitydata,
  wolfenstein: wolfensteindata,
  blender: blenderdata,
  calibre: calibredata,
  jquery: jquerydata,
  react: reactdata,
  ...
  nodejs: nodejsdata,
  python: pythondata,
  cplusplus: cplusplusdata,
  java: javadata,
  jscrashcourse: jscrashcoursedata,
  pythoncourse: pythoncoursedata,
  hackide: hackidedata,
  reactpdf: reactpdfdata,
  htmlpdf: htmlpdfdata,
  javascriptpdf: javascriptpdfdata,
  androidpdf: androidpdfdata,
  csspdfdata: csspdfdata,
  cpluspluspdf: cpluspdfdata,
  pythonpdf: pythonpdfdata,
  javapdf: javapdfdata
}
