...
import trignometrydata from './trignometrydata'
import lineareqdata from './lineareqdata'
import risetwpdata from './risetwpdata'
import cosmouniversedata from './cosmouniversedata'
import organicchemdata from './organicchemdata'
import aromaticcompoundsdata from './aromaticcompoundsdata'
import macromoleculesdata from './macromoleculesdata'
...
Set('trignometry', trignometrydata)

Set('lineareq', lineareqdata)

Set('risetwp', risetwpdata)

Set('cosmouni', cosmouniversedata)

Set('organicchem', organicchemdata)

Set('aromaticcomp', aromaticcompoundsdata)

Set('macromolecules', macromoleculesdata)

Set('androidstudio',androidstudio)
